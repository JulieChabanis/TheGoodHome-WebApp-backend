...
class AppartmentServiceTest {
    ...
    @Test
     public void testAddAppartment() {
        AppartmentEntity appartmentEntity = new AppartmentEntity(1,"Title", "Description", "848 Wall Street", "740 Building Road", "New-York", "00001", 800, 100, 700);
    ...
    @Test
     public void testGetAppartments() {
        AppartmentEntity appartment1 = new AppartmentEntity(1,"Title", "Description", "700 Street Road", "3B Old Money", "New-York", "00001", 1300, 200, 1100);
        AppartmentEntity appartment2 = new AppartmentEntity(2,"Title", "Description", "118 Montague Saint", "Brooklyn", "New-York", "11201", 800, 100, 700);
        AppartmentEntity appartment3 = new AppartmentEntity(3,"Title", "Description", "54 Watts Saint", "Soho", "New-York", "10013", 2100, 200, 1900);
    ...
    void testGetAppartment() {
        AppartmentEntity appartmentEntity = new AppartmentEntity(1L, "Title", "Description", "54 Watts Saint", "Soho", "New-York", "10013", 2100, 200, 1900);
    ...
    @Test
     void testUpdateAppartment() {
        ...
        AppartmentEntity updatedAppartment = new AppartmentEntity(1L,"Title", "Description", "53 Watts Saint", "Soho", "New-York", "10013", 2100, 200, 1900);
